...
final List<Resource> allResources = [
  ...
  const Resource(
    ...
    deadline: 'Dec 13–16, 2026',
    deadlineIso: '2026-12-13T23:59:00Z',
  ...
  const Resource(
    ...
    deadlineIso: '2026-09-30T23:59:00Z',
    icon: Icons.emoji_events,
  ...
  const Resource(
    ...
    deadlineIso: '2026-10-26T23:59:00Z',
    icon: Icons.emoji_events,
  ...
  const Resource(
    ...
    deadlineIso: '2026-08-01T23:59:00Z',
    icon: Icons.emoji_events,
  ...
  const Resource(
    ...
    deadlineIso: '2026-05-01T23:59:00Z',
    icon: Icons.emoji_events,
  ...
  const Resource(
    ...
    deadlineIso: '2027-01-31T23:59:00Z',
    icon: Icons.emoji_events,
  ...
  const Resource(
    ...
    deadlineIso: '2027-02-28T23:59:00Z',
    icon: Icons.emoji_events,
    url:
  ...
  const Resource(
    ...
    deadlineIso: '2026-07-05T23:59:00Z',
    icon: Icons.emoji_events,
  ...
  const Resource(
    ...
    deadlineIso: '2026-09-01T23:59:00Z',
    icon: Icons.emoji_events,
    url: 'TODO',
    links: ['TODO'],
  ),
  const Resource(
    ...
    deadlineIso: '2027-06-01T23:59:00Z',
    icon: Icons.emoji_events,
    url: 'TODO',
    links: ['TODO'],
  ),
  ...
  const Resource(
    ...
    deadline: 'October 14, 2026 (team reg. closes)',
  ...
  // ),
  //also summer this is starting to pmo
  // const Resource(
  //   id: 'leb_policy_brief',
  ...
  //check back later for fall 2027 deadlines
  // const Resource(
  //   id: 'culr_essay',
...
const List<DeadlineItem> upcomingDeadlines = [
  DeadlineItem(
    ...
    date: 'May 1, 2026 (reg. closes)',
    dateIso: '2026-05-01T23:59:00Z',
    resourceId: 'cyberpatriot_afa',
    majorTags: ['cybersecurity', 'cs', 'data_sci', 'networking', 'linux'],
  ),
  DeadlineItem(
    title: 'StellarXplorers Aerospace STEM Program',
    date: 'Oct 14, 2026 (team reg. closes)',
    dateIso: '2026-10-14T23:59:00Z',
    resourceId: 'stellarxplorers',
    majorTags: ['aerospace', 'physics', 'cs', 'applied_math'],
  ),
  DeadlineItem(
    title: 'AMC 10 / 12',
    date: 'Sep 30, 2026 (Early Bird reg.)',
    dateIso: '2026-09-30T23:59:00Z',
    resourceId: 'amc',
    majorTags: ['math', 'problem_solving', 'logic'],
  ),
  DeadlineItem(
  ...
  DeadlineItem(
    title: 'Conrad Challenge',
    date: 'Jan 2027 (submission)',
    dateIso: '2027-01-31T23:59:00Z',
    resourceId: 'conrad_challenge',
    majorTags: ['innovation', 'entrepreneurship', 'env_sci', 'cs', 'biology'],
  ),
  DeadlineItem(
    title: 'USABO',
    date: 'Aug 1, 2026 (Registration Opens)',
    dateIso: '2026-08-01T23:59:00Z',
    resourceId: 'usabo',
    majorTags: ['biology', 'genetics', 'anatomy'],
  ),
  DeadlineItem(
    title: 'National Economics Challenge',
    date: 'Jan–Apr 2027 (state varies)',
    dateIso: '2027-01-31T23:59:00Z',
  ...
  DeadlineItem(
    ...
    date: 'Aug 2026 (Registration Opens)',
    dateIso: '2026-08-31T23:59:00Z',
  ...
  DeadlineItem(
    title: 'LSESU Annual Essay Competition',
    date: 'Sep 1, 2026',
    dateIso: '2026-09-01T23:59:00Z',
    resourceId: 'lsesu_essay',
    majorTags: ['economics', 'polisci', 'intl_rel', 'pub_policy', 'sociology'],
  ),
  DeadlineItem(
    title: 'International Economics Essay Competition',
    date: 'Sep 2026 (approx.)',
    dateIso: '2026-09-01T23:59:00Z',
    resourceId: 'intl_econ_essay',
    majorTags: ['economics', 'intl_rel', 'pub_policy'],
  ),
  DeadlineItem(
    title: 'AMC 10 / 12 (Contest)',
    date: 'Nov 2026 (exact TBD)',
    dateIso: '2026-11-05T23:59:00Z',
    resourceId: 'amc',
    majorTags: ['math', 'problem_solving', 'logic'],
  ),
  DeadlineItem(
    title: 'Anthology Nature Writing Competition',
    date: 'Sep 30, 2026',
    dateIso: '2026-09-30T23:59:00Z',
  ...
  DeadlineItem(
    title: 'High School Fed Challenge',
    date: 'Feb 2027 (regional dates vary)',
    dateIso: '2027-02-28T23:59:00Z',
    resourceId: 'fed_challenge',
    majorTags: ['economics', 'business', 'pub_policy'],
  ),
  DeadlineItem(
    title: 'Global Impact Competition',
    date: 'Jun 2027 (approx.)',
    dateIso: '2027-06-01T23:59:00Z',
